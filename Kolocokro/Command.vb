...
Public Class Command
    ...
    Public Function OpenFrame(elementName As String)
        Try
            Dim frameElement As IWebElement = driver.FindElement(By.XPath(elementName))
    ...
    Public Function SelectbyText(elementName As String, text As String)
        Try
            Dim dropdown As IWebElement = driver.FindElement(By.XPath(elementName))
            Dim SelectText As New SelectElement(dropdown)
    ...
    Public Function sendKeysByXpath(elementName As String, text As String)
        Try
            Dim element As IWebElement = driver.FindElement(By.XPath(elementName))
            Thread.Sleep(1000)
    ...
    Public Function Type(elementName As String, text As String)
        Try
            Dim element As IWebElement = driver.FindElement(By.XPath(elementName))
    ...
    Public Function TypeBackspace(elementName As String, count As Integer)
        Try
            Dim element As IWebElement = driver.FindElement(By.XPath(elementName))
            Dim actions As New Actions(driver)
    ...
    Public Function UploadFile(elementName As String, filePath As String)
        Try
            Dim fileInput As IWebElement = driver.FindElement(By.XPath(elementName))
            Thread.Sleep(1000)
            fileInput.Click()
            Thread.Sleep(1000)
        ...
        End Try
    End Function
    Public Function WaitForElement(elementName As String, seconds As Integer)
        Try
            'Dim seconds As Integer = milliseconds * 1000
            Dim Wait As WebDriverWait = New WebDriverWait(driver, TimeSpan.FromSeconds(seconds))
            Wait.Until(ExpectedConditions.ElementExists(By.XPath(elementName)))
            Return "Selesai"
        Catch
            Return "Error"
        End Try
