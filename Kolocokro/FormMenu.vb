...
Public Class FormMenu
    ...
    Private Sub editTask_Click(sender As Object, e As EventArgs) Handles editTask.Click
        If pilihanTask.SelectedIndex <> -1 Then
            ...
            If File.Exists(sourceFilePath) Then
                ...
                If saveFileDialog.ShowDialog() = DialogResult.OK Then
                    Try
                        File.Move(sourceFilePath, saveFileDialog.FileName)

                        pilihanTask.Items(pilihanTask.SelectedIndex) = Path.GetFileName(saveFileDialog.FileName)

                        MessageBox.Show("Nama file CSV berhasil diubah.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Catch ex As Exception
                        MessageBox.Show("Terjadi kesalahan: " & ex.Message, "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    End Try
                End If
    ...
    Private Sub salinTask_Click(sender As Object, e As EventArgs) Handles salinTask.Click
        If pilihanTask.SelectedIndex <> -1 Then
            ...
            If File.Exists(sourceFilePath) Then
                ...
                If saveFileDialog.ShowDialog() = DialogResult.OK Then
                    Try
                        File.Copy(sourceFilePath, saveFileDialog.FileName)

                        MessageBox.Show("File CSV berhasil disalin.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                        pilihanTask.Items.Add(Path.GetFileName(saveFileDialog.FileName))
    ...
    Private Sub exportTask_Click(sender As Object, e As EventArgs) Handles exportTask.Click
        If pilihanTask.SelectedIndex <> -1 AndAlso pilihanTask.SelectedItem IsNot Nothing Then
            ...
            saveFileDialog.Title = "Pilih Lokasi untuk Menyimpan File CSV yang Diexport"
            saveFileDialog.FileName = selectedFileName
            ...
            If saveFileDialog.ShowDialog() = DialogResult.OK Then
                Try
                    ...
                    If Not File.Exists(destinationPath) Then
                        ...
                        MessageBox.Show("File CSV berhasil diexport.", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Else
                    ...
                    End If
                Catch ex As Exception
                    MessageBox.Show("Terjadi kesalahan saat mengekspor file CSV: " & ex.Message, "Kesalahan", MessageBoxButtons.OK, MessageBoxIcon.Error)
                End Try
            End If
        Else
    ...
    Private Sub bwMain_DoWork(sender As Object, e As DoWorkEventArgs) Handles bwMain.DoWork
                        ...
                        Case "sendKeys"
                            If value.Contains("DataCSV") Then
                                If loopIndex > 0 Then
                                    ...
                                    Dim outputCSV = dataCSV(loopIndex)(colCSV)
                                    output = bot.sendKeysByXpath(valueOrURL, outputCSV)
                                ...
                                End If
                            Else
                                output = bot.sendKeysByXpath(valueOrURL, value)
                            End If
                            Exit Select
                        Case "Type"
        ...
        'isPlaying = False
        'btnPlay.Text = "Play" ' Mengganti teks tombol menjadi "Play" setelah selesai atau di-pause
        'Else
        'isPlaying = False
        'btnPlay.Text = "Play" ' Mengganti teks tombol menjadi "Play" jika tombol pause ditekan
        'End If
    End Sub
...
chrome.webRequest.onAuthRequired.addListener(
    ...
    'Private Sub btnCleanDriver_Click(sender As Object, e As EventArgs)
